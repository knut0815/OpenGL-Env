...
public:
    ...
    inline glm::vec3 getFrontVector() const { return camFront; }
    inline glm::vec3 getPositionVector() const { return camPosition; }
    inline glm::vec3 getTargetVector() const { return camTarget; }
    inline glm::vec3 getUpVector() const { return camUp; }
